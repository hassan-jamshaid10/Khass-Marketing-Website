...
function khaas_theme_setup() {
    ...
    // Add theme support for title tag and post thumbnails (optional)
...
function khaas_enqueue_assets() {
    ...
    // ✅ Custom stylesheet from /assets/css/
    ...
    // JavaScript (optional)
    wp_enqueue_script('khaas-main-js', get_template_directory_uri() . '/assets/js/main.js', array(), false, true);
}
