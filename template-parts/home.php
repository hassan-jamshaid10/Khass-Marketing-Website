...
<div class="hero-content" data-aos="fade-in" data-aos-duration="1500">
  ...
  <div class="hero-vector">
    <picture>
      <!-- Mobile first -->
      <source media="(max-width: 768px)" srcset="<?php echo get_template_directory_uri(); ?>/assets/images/v1.svg">
      <!-- Default / Desktop -->
  ...
  <div class="container">
    ...
    <div class="mobile-view">
      <div class="idea-step" data-aos="fade-up" data-aos-delay="100">
        ...
        <div>
          <h3>Strategy</h3>
          <p>Develop long-term AI strategies to maximize the potential of custom software solutions for your business
            growth.</p>
        </div>
      </div>
      ...
      <div class="idea-step" data-aos="fade-up" data-aos-delay="200">
        ...
        <div>
          <h3>Design</h3>
          <p>Craft intuitive designs with cutting-edge tools to create AI software development services tailored to your
            vision.</p>
        </div>
      </div>
      ...
      <div class="idea-step" data-aos="fade-up" data-aos-delay="300">
        ...
        <div>
          ...
          <p>Build robust, scalable solutions and ensure excellence through rigorous testing of your AI-driven
            applications.</p>
        </div>
      </div>
      ...
      <div class="idea-step" data-aos="fade-up" data-aos-delay="500">
        ...
        <div>
          <h3>Support</h3>
          <p>Provide ongoing support for AI software development services to keep your systems optimized and
            future-ready.</p>
        </div>
      </div>
    </div>
...
<div class="stats-cta-wrap">
  <div class="diagonal-vector" aria-hidden="true">
    <picture>
      <!-- Mobile first -->
      <source media="(max-width: 768px)" srcset="<?php echo get_template_directory_uri(); ?>/assets/images/v2.svg">
      <!-- Default / Desktop -->
      <img src="<?php echo get_template_directory_uri(); ?>/assets/images/vector2.png" alt="Diagonal Vector" />
    </picture>
  </div>
  ...
  <section class="cta-section">
    ...
    <div class="cta-bg-svg">
      <svg width="1300" height="1090" viewBox="0 0 1300 1090" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <defs>
          <filter id="filter0_f_275_127" x="0" y="0" width="1300" height="1090" filterUnits="userSpaceOnUse"
            color-interpolation-filters="sRGB">
            <feFlood flood-opacity="0" result="BackgroundImageFix" />
            <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
            <feGaussianBlur stdDeviation="100" result="effect1_foregroundBlur_275_127" />
          </filter>
          <linearGradient id="paint0_linear_275_127" x1="387.313" y1="241.194" x2="547.519" y2="914.388"
    ...
    <div class="cta-card" data-aos="fade-up" data-aos-delay="150" data-aos-duration="800">
      ...
      <svg class="cta-lines" viewBox="0 0 1296 495" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg"
        aria-hidden="true">
        <path
          ...
          stroke="url(#paint0_linear_630_20)" stroke-width="6.72453" stroke-linecap="round" />
        <defs>
          <linearGradient id="paint0_linear_630_20" x1="626.154" y1="-176.513" x2="412.881" y2="1599.47"
            gradientUnits="userSpaceOnUse">
      ...
      <ul class="faq-list">
        <li class="faq-item">
          ...
          <div class="faq-answer">
            <p>Khaas Marketing stands out through our unique combination of cutting-edge design expertise, data-driven
              strategies, and personalized client relationships. We don't just create campaigns—we build scalable
              solutions that grow with your business, backed by transparent communication and measurable results that
        ...
        <li class="faq-item">
          ...
          <div class="faq-answer">
            <p>Absolutely! Every design and campaign we create is built with scalability as a core principle. We use
              modular design systems, flexible frameworks, and future-proof technologies that allow your marketing
              assets to grow and adapt as your business expands, ensuring long-term value and consistency.</p>
          </div>
        </li>
        ...
        <li class="faq-item">
          ...
          <div class="faq-answer">
            <p>We serve a diverse range of industries including e-commerce, healthcare, fintech, education, real estate,
              and professional services. Our custom software solutions are tailored to meet the specific regulatory,
              security, and user experience requirements of each industry, ensuring compliance and optimal performance.
            </p>
          </div>
        </li>
        ...
        <li class="faq-item">
          ...
          <div class="faq-answer">
            <p>Our onboarding process is designed to be smooth and comprehensive. It starts with a discovery call to
              understand your goals, followed by a detailed project brief, team assignment, and kickoff meeting. We
              establish clear communication channels, set milestones, and provide regular updates to ensure you're
              always in the loop.</p>
          </div>
        </li>
        ...
        <li class="faq-item">
          ...
          <div class="faq-answer">
            <p>Timelines vary based on project complexity, but typically range from 8-16 weeks for standard applications
              to 6-12 months for enterprise solutions. We use agile methodologies to deliver working prototypes early
              and often, allowing for iterative improvements and faster time-to-market.</p>
          </div>
        </li>
      </ul>
    </div>
          ...
          <ol class="hww-steps">
            <li class="hww-step">
              ...
              <div class="step-text">
                <h3>Step 1</h3>
                <h4>Let’s Talk</h4>
                <p>Hop on a quick discovery call. We’ll learn about your goals, timeline, budget, and the kind of talent
                  you need – so we can build the right plan for you.</p>
              </div>
            </li>
            ...
            <li class="hww-step">
              ...
              <div class="step-text">
                <h3>Step 3</h3>
                <h4>Launch &amp; Grow.</h4>
                <p>We get to work fast – tracking milestones, sharing updates, and adjusting along the way to make sure
    ...
    <div class="testimonial-section">
      ...
      <div class="card-stack">
        <div class="card active">
          <p>
            Partnering with Khaos Marketing was a game-changer. Their cutting edge design and seamless functionality
            elevated our website experience resulting in increased traffic, higher conversions, and exceptional user
            feedback. Their team's strategic insights and top-tier collaboration made all the difference.
          </p>
          <div class="author">
